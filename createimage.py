...
try:
    ...
    params = {
        "BlueprintName": "dsh_nginx",
        "Description": "dsh_to_public_https",
        "InstanceId": "lhins-qojobi8w",
        "ForcePowerOff": False
    }
    req.from_json_string(json.dumps(params))

    # 返回的resp是一个CreateBlueprintResponse的实例，与请求对象对应
    resp = client.CreateBlueprint(req)
    # 输出json格式的字符串回包
